...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_sweetalert__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_sections_Home_vue__ = __webpack_require__(81);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29), __webpack_require__(53).setImmediate))
...
var update = __webpack_require__(39)("9e85698c", content, false);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-233edfb9", Component.options)
  } else {
    hotAPI.reload("data-v-233edfb9", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(39)("345ef096", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-233edfb9\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Home.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-233edfb9\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./Home.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        submitEmail: function submitEmail(event) {
            ...
            var self = this;
            __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post('/newsletterUser', {
        ...
        circle: function circle() {
            ...
            var Blob = function () {
                function Blob() {
                    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, Blob);

                    this.points = [];
                }

                __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Blob, [{
                    key: 'init',
                    value: function init() {
                    ...
                    key: 'position',
                    set: function set(value) {
                        if ((typeof value === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(value)) == 'object' && value.x && value.y) {
    ...
    mounted: function mounted() {
        ...
        setTimeout(function () {
            ...
            var colors = [0x839fcd, 0x9eb4d8, 0xc6d3e8];
            var camera = void 0,
                scene = void 0,
                renderer = void 0;
            var obj = [];
            ...
            function init() {
                ...
                var plane = new THREE.Mesh(new THREE.PlaneGeometry(5000, 5000), groundMaterial);
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "section" }, [
      _c("div", { staticClass: "logo" }, [
        _c("img", {
          attrs: { src: "/images/logo_deep_blue_white.png", alt: "Deep Blue" }
        }),
        _vm._v(" "),
        _c("h2", [
          _vm._v("ERC20 Ethereum Standard Token for Embedded Computing")
        ])
      ]),
      _vm._v(" "),
      _c("div", { attrs: { id: "canvasHome" } })
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c("div", { staticClass: "aditional" }, [
      _c("div", { staticClass: "container" }, [
        _c("p", [_vm._v("Early adopt this ERC20 Ethereum Standard.")]),
        _vm._v(" "),
        _c("p", [
          _vm._v("Unlock all the power provided by millions of devices.")
        ]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
            "Improve the world including the excluded people and computers into the blockchain usage."
          )
        ]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
            "Use or create meaningful ways to exchange processing power for everybody."
          )
        ])
      ])
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-233edfb9", module.exports)
  }
}
